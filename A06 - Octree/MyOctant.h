...
namespace Simplex
{
    ...
    class MyOctant
    {
        ...
        MeshManager* m_pMeshManager = nullptr; //Mesh Manager singleton
        MyEntityManager* m_pEntityManager = nullptr; //Entity Manager Singleton
    ...
    public:
        ...
        */
        ...
        USAGE: Constructor
        ARGUMENTS:
        - a_pParent -> The parent node of the Octree
        - vector3 a_v3Center -> Center of the octant in global space
        - float a_fSize -> size of each side of the octant volume
        - a_uLevel -> The current level of the node
        OUTPUT: class object
        */
        MyOctant(MyOctant* a_pParent, vector3 a_v3Center, vector3 a_fSize, uint a_uLevel);
